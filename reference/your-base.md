...
| Where the tracker is written up | The coach-facing instructions for Attendance Grid and Trainee Scorecard live in **STAMPSTAFF TRAINING SOP V.2.2026** — https://docs.google.com/document/d/1vJ_pM97Fq9_S-Y33SSHs-w-OqJ-pRJWTr8UMolhETTU/edit — under "How to use the Airtable attendance tracker". Change a field here and that section needs the same change. Master markdown: `templates/training-sop-v2.md`. |
