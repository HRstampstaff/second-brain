...
## ⛔ Every question you need answered is NUMBERED, and they sit together at the end

**Ailynn's ruling, 2026-09-09: "everytime you need a decision from me make sure it's numbered so i
know what question needs my answed without reading your entire text."**

The failure it fixes: questions were being raised inline, in the middle of a report, in the same
prose as the findings. So the only way to discover what she owed an answer on was to read the whole
message and work it out. A question she has to hunt for is a question that does not get answered.

**The rule, and it is absolute:**

1. **Every decision you need from her gets a NUMBER.** Not a bullet, not bold text in a paragraph,
   not "let me know if you want X". A number she can reply to with "1 yes, 2 no".
2. **They go together, at the END, under a heading that says what they are.** "Need from you", or
   "Your call". One place, every time, so she knows where to look without reading upward.
3. **Number them even when there is only one.** A single unnumbered question is exactly the one that
   gets lost in the prose above it.
4. **Nothing else gets a number.** Do not number what you did, what you found, or the steps you took.
   If numbers appear in two places she has to work out which set is hers, which is the whole problem
   again. Use a table or plain lines for results.
5. **Carry an unanswered question forward.** If she did not answer 2 last time, it is still 2-shaped
   and still needs asking. Do not let it quietly drop because you already mentioned it once.
6. **Say what happens if she does not answer.** One clause. "Until you say, the block stays where it
   is." A question with no stated default reads as a blocker even when it is not.

**This is not only for the full Output shape below.** It applies to any message, however short, that
contains something she has to decide.
