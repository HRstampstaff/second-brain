# VA clock in/out rules for payroll

Set by Ailynn, 2026-09-01. Applies to BambooHR punches when calculating VA payroll.

- **Grace window: 5 minutes.** A clock-in up to 5 minutes after the scheduled start time still
  counts as on time. No penalty.
- **Client-to-client crossover.** VAs clock out of one client and into the next during the day. If
